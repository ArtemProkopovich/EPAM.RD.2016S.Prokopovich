...
namespace DoSomethingClient
{
    public class DomainAssemblyLoader : MarshalByRefObject
    {
        ...
        public Result LoadFile(string path, Input data)
        {
            ...
            Type type = types.FirstOrDefault(e => e.GetCustomAttribute(typeof(DoSomethingAttribute)) != null && e.GetInterface(nameof(IDoSomething)) == null); // TODO: Find first type that has DoSomething attribute and don't implement IDoSomething.
